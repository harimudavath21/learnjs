...
console.log(e & f);  // 1 → 0101 & 0011 = 0001
console.log(e | f);  // 7 → 0101 | 0011 = 0111
console.log(e ^ f);  // 6 → 0101 ^ 0011 = 0110
console.log(~e);     // -6 → NOT 0101 = 1010 (2's complement)
console.log(e << 1); // 10 → 0101 becomes 1010
console.log(e >> 1); // 2 → 0101 becomes 0010
